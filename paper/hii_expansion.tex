...
At $t=0$ the interior pressure satisfies $P_\mathrm{in} = n_0 m_H c_\mathrm{II}^2$,
so the net force on the shell (Equation~\ref{eq:momentum}) is exactly zero and
$\dot{v}=0$.  The numerical integrator uses a seed mass
...
systems converge to the same asymptotic scaling $R\propto t^{4/7}$ because the
velocity field is dominated by the interior pressure rather than the shell mass.
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.7\linewidth]{../figures/constant_density.png}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.7\linewidth]{../figures/powerlaw_density.png}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.7\linewidth]{../figures/cored_density.png}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.6\linewidth]{../figures/classic_vs_modified.png}
